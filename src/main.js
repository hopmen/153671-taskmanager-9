...
const getComponent = (component) => ({
  ...
  cardEdit: `<article class="card card--edit card--black">
...
const redner = (el, component) => {
  document.querySelectorAll(el).forEach((i) => {
    i.outerHTML = getComponent(component);
  });
};

redner(`menu`, `menu`);
redner(`search`, `search`);
redner(`filter`, `filter`);
redner(`cardEdit`, `cardEdit`);
redner(`card`, `card`);
redner(`loadMore`, `loadMore`);
